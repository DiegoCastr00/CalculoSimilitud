...
output_csv = "data_blip2SDXL.csv"

# Cargar datos originales
data = pd.read_csv(metadata_path)
data["file_name"] = data["file_name"].str.replace("imagenes/SDXL/", "", regex=False)
...
def generate_caption(image_path):
    try:
        raw_image = Image.open("imagenes/SDXL/" + image_path).convert('RGB')
