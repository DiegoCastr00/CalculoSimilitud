...
log_file = os.path.abspath('merge23.log')
logging.basicConfig(
    filename=log_file,
    level=logging.INFO,
...
if __name__ == "__main__":
    ...
    input_csv = os.path.join(base_dir, "merge2-3_faltantes.csv") 
    output_dir = os.path.join(base_dir, "merge23")
    
    # Asegurar que el directorio de salida exista
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
        
    output_csv = os.path.join(output_dir, "merge23.csv")
