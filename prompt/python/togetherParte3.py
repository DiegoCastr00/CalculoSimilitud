...
log_file = os.path.abspath('together3.log')
logging.basicConfig(
    filename=log_file,
    level=logging.INFO,
...
if __name__ == "__main__":
    ...
    input_csv = os.path.join(base_dir, "parte_3.csv") 
    output_dir = os.path.join(base_dir, "together3")
    
    # Asegurar que el directorio de salida exista
    if not os.path.exists(output_dir):
        os.makedirs(output_dir)
        
    output_csv = os.path.join(output_dir, "together3.csv")
